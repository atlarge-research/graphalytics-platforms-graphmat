...
public class TopActorTopMission extends AbstractOperationModel {
    ...
    public TopActorTopMission() {
        super(GraphMatType.TopActor, GraphMatType.TopMission);
    }
...
//                    add("ArchivingTime");
    ...
    protected class ProcessingTimeDerivation extends DerivationRule {
        ...
        public boolean execute() {
            Operation operation = (Operation) entity;
            Operation processGraph = operation.findSuboperation(GraphMatType.Job).findSuboperation(GraphMatType.ProcessGraph);
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
                Operation operation = (Operation) entity;
                String summary = String.format("The [%s] operation is the top-level operation of each GraphMat job. ", operation.getName());
