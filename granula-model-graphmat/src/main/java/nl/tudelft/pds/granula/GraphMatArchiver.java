...
//            GranulaArchiver granulaArchiver = new GranulaArchiver(jobSource, new GraphMat(), outputPath);
...
//        }
        ...
        GranulaArchiver granulaArchiver = new GranulaArchiver(jobDirSource, new GraphMat(), outputPath);
        granulaArchiver.archive();
